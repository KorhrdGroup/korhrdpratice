      ...
      {!isLogin && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '10px 16px', background: '#fff', borderBottom: '1px solid rgba(0,0,0,0.06)', position: 'sticky', top: 0, zIndex: 100 }}>
          ...
          <Link href="/admin/payments" style={{
            padding: '6px 18px', borderRadius: 8, fontSize: 14, fontWeight: pathname === '/admin/payments' ? 700 : 500,
            background: pathname === '/admin/payments' ? '#3182f6' : '#f2f4f6',
            color: pathname === '/admin/payments' ? '#fff' : '#4e5968',
            textDecoration: 'none',
          }}>
            결제
          </Link>
